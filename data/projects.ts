export const projectsData = [
  {
    ...
    description: 'Engineered a full-stack recruitment platform as part of a Database Management and Software Engineering project, following Agile principles. The platform facilitates collaborative hiring processes among multiple organizations. ',
    githubLink: 'https://github.com/kabir325/Collaborative_recruitment_platform',
    techStack: ['Python', 'Streamlit']
  },

  {
    id: 'project-id-2', 
    name: 'REAL-TIME SENSOR DATA TRANSMISSION',
    description: 'Implemented a secure communication system using two ESP32 microcontrollers to transmit pulse and temperature sensor data in real time, ensuring accurate data transfer between devices.',
    githubLink: 'https://github.com/kabir325/Esp32_Sensor_Data_Transmission',
    techStack: ['ESP-32', 'Arduino','PlatformIO']
  },
  {
    id: 'project-id-3',
